...
add_action('admin_init','wp_ajax_add_actions');
function wp_ajax_add_actions(){
    ...
    add_action('wp_ajax_create_tcs_shipment','create_tcs_shipment');
    add_action("admin_head",'woocommerce_admin_order_actions_button_css');
    add_action('admin_head', 'add_order_track_action_button_css');
...
function woocommerce_admin_order_actions_button_css(){
    echo '<style>.view.create_consignment::after{content: "\f133"}</style>';
}

function add_order_track_action_button_css()
{
    echo '<style>.view.tracking::after { content: "\f173" !important; }</style>';
}

function create_tcs_shipment(){
